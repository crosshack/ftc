...
window.TOPICS_DATA = [
  ...
  ,
  {
    slug: "behavioral-econ-001a",
    title: "『蹴っておけばよかった』ラムズの4th&1",
    excerpt: "2025年シーズンWeek 5、ラムズ対フォーティナイナーズ戦のオーバータイム。同点にできるフィールドゴールを見送り、4th&1のギャンブルを選んだショーン・マクベイの判断を、行動経済学の「プロスペクト理論」から解説する。",
    url: "topics/behavioral-econ-001a.html",
    date: "2026-09-06",
    readMin: 6,
    theme: { slug: "behavioral-econ", name: "アメフトの行動経済学", part: "#001a" },
    tags: [
